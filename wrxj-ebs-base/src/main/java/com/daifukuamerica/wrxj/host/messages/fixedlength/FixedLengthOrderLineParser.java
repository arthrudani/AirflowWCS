...
import com.daifukuamerica.wrxj.host.messages.delimited.OrderLineParser;
...
/**
  ...
  *   <ol type="A">
  *     <li><code>'OrderLine     ADD   field1     field2     ...     fieldN' or</code></li>
  *     <li><code>'OrderLine     MODIFYsearchKeyField     field2     ...     fieldN'</code> or </li>
  *     <li><code>'OrderLine     DELETEsearchKeyField1     ...     searchKeyFieldN'</code></li>
  *   </ol>
  ...
  *  @since  29-May-06
  */
public class FixedLengthOrderLineParser extends OrderLineParser
{
 /**
  * Default constructor for a fixed length Order Line parser.
  */
  public FixedLengthOrderLineParser() throws DBException
  {
    super();
  }
    ...
    if ((vnAction = MessageHelper.getFixedLengthDataAction(ipHostData.getMessageBytes())) > 0)
    {
      ...
      if (mpOldata.getOrderID().trim().length() == 0)
      {
        ...
        throw new InvalidHostDataException(HostError.INVALID_DATA,
                                           "Order ID. is missing! Attempted operation failed...",
