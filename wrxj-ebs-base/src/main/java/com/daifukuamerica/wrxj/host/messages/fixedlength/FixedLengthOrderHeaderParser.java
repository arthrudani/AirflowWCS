...
import com.daifukuamerica.wrxj.host.messages.delimited.OrderHeaderParser;
...
import com.daifukuamerica.wrxj.jdbc.DBRuntimeException;
  ...
  *   <ol type="A">
  *     <li><code>'OrderHeader     ADD   field1     field2     ...     fieldN' or</code></li>
  *     <li><code>'OrderHeader     MODIFYsearchKeyField     field2     ...     fieldN'</code> or </li>
  *     <li><code>'OrderHeader     DELETEsearchKeyField1     ...     searchKeyFieldN'</code></li>
  *   </ol>
  ...
  */
public class FixedLengthOrderHeaderParser extends OrderHeaderParser
{
 /**
  * Default constructor for a fixed length Order Header parser.
  */
  public FixedLengthOrderHeaderParser() throws DBException
  {
    super();
  }
