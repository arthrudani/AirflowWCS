 ...
 * Rack LHB Sequencer 
 *
 * <p><b>Details:</b> A RackLHBSequencer sequences rack locations left to 
 * right, front to back and bottom to top.
 * 
 */
public class RackLHBSequencer extends RackBHLSequencer
{
  /**
   * Get Description.
   *
  ...
  {
    return("Rack Left to Right - Front to Back - Bottom to Top");
  }
