...
function searchHistory() {
	table.ajax.url("/airflowwcs/history/listSearch?startingDate=" + $("#scStarting").val() + "&endingDate=" + $("#scEnding").val() + "&loadId=" + $("#scLoadId").val() + "&lot=" + $("#scLot").val() + "&lineId=" + $("#scLineId").val()).load(function() {
		$("#divExecuting").hide();
	});
}
