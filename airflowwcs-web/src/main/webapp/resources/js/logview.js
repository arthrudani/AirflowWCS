...
$(document).ready(function(){
	...
	$("#scDescription").on('keyup', function (e) {
	    if (e.keyCode == 13)
	    {
	    	$("#divExecuting").show();
	    	searchHistory();
...
{
	table.ajax.url("/airflowwcs/logview/listSearch?startingDate="+$("#scStarting").val()+"&endingDate="+$("#scEnding").val()+"&description="+$("#scDescription").val()).load(function()
	{
		$("#divExecuting").hide();
