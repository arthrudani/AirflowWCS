...
<head>
	...
	<meta name="description" content="WRXJ - Loads"/>
	<meta charset="utf-8"/>
									...
									<div class="row panel-body">
										...
										<div class="col-sm-6">
											<div class="form-group-sm">
												<label for="scwarehouse" class="control-label">Location</label>
...
<security:authorize access="hasAnyRole('ROLE_ELEVATED','ROLE_ADMIN','ROLE_MASTER')">
	<wrxj:ajaxTable metaDataName="Load" ajaxUri="/airflowwcs/load/empty"
		...
		hasSearch="false" numPageLength="100"></wrxj:ajaxTable>
<%@include file="loadAdd-loadmover-shelf.jspf" %>
<%@include file="loadModify-loadmover-shelf.jspf" %>
</security:authorize>
<security:authorize access="!hasAnyRole('ROLE_ELEVATED','ROLE_ADMIN','ROLE_MASTER')">
	<wrxj:ajaxTable metaDataName="Load" ajaxUri="/airflowwcs/load/empty"
		metaId="Load ID" hasRefresh="true" hasFilter="true" hasAdd="false"
		hasAutoRefresh="true" hasExcel="true" hasColVis="true"
		prefHideColumns="${userPref.tableColumnVisibility['Load']}"
		hasSearch="false" numPageLength="100"></wrxj:ajaxTable>
</security:authorize>
