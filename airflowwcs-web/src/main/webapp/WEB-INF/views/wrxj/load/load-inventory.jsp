			...
			<form:form cssClass="form-horizontal" id="load-filtering-form" action="${formUrl}" method="POST" modelAttribute="loadDataModel">
				<div class="panel panel-default">
					...
					<div class="row">
						...
						<!---------Slave Board Field------------->	
									<div class="col-sm-4">
										<span class="input-group-addon">Slave Board</span>
										<form:input path="mcKey" cssClass="form-control" id="mcKey" placeholder="Slave Board"/>
									</div>	
						<!---------Amount Full------------->	
									<div class="col-sm-3">
										<span class="input-group-addon">Amount Full</span>
...
<!---------End of First Row------------->	
	...
	<security:authorize access="hasAnyRole('ROLE_USER','ROLE_ADMIN','ROLE_MASTER')">
		<wrxj:ajaxTable metaDataName="Load" ajaxUri="/airflowwcs/load/empty" 
				metaId="TrayID" hasRefresh="true" hasFilter="true" hasAdd="true" 
				hasAutoRefresh="true" hasExcel="true" hasColVis="true"  prefHideColumns="${userPref.tableColumnVisibility['Load']}"  hasSearch="true" numPageLength="100"></wrxj:ajaxTable>
	</security:authorize>
...
<%@include file="loadModify-inventory.jspf" %>
<%@include file="loadRetrieve.jspf" %>
<jsp:include page="loadAddBody.jsp"></jsp:include>

<script src="<spring:url value="/resources/js/load-inventory.js"/>" type="text/javascript"></script>
