									...
									<div class="row panel-body">
										...
										<div class="col-sm-2">
											<div class="form-group-sm">
												...
												<form:input path="loadId" cssClass="form-control" id="loadId" placeholder="Load ID" maxlength="${maxLengthLoadId}"/>
											</div>
										</div>
										<%---------Tracking ID-------------%>	
										<div class="col-sm-1" style="display:none;">
											<div class="form-group-sm">
												<label for="mcKey">Tracking&nbsp;ID</label>
												<form:input path="mcKey" cssClass="form-control" id="mcKey" placeholder="Tracking ID" maxlength="8"/>
											</div>
										</div>
										<%---------From Location-------------%>
										<div class="col-sm-4">
										...
										<div class="col-sm-4">
											<div class="form-group-sm">
												...
												<div class="input-group">
													...
													<div class="input-group-addon">-</div>
													<form:input path="nextAddress" cssClass="form-control" id="nextAddress" placeholder="Next Address" size="9" maxlength="9"/>
													<div class="input-group-addon">-</div>
													<form:input path="nextShelfPosition" cssClass="form-control" id="nextShelfPosition" placeholder="Next Position" size="3" maxlength="3"/>
												</div>
											</div>
										</div>
										<%---------Device ID Field-------------%>
...
<security:authorize access="hasAnyRole('ROLE_ELEVATED', 'ROLE_ADMIN', 'ROLE_MASTER')">
	<script src="<spring:url value="/resources/js/recovery-loadmover-elevated.js"/>" type="text/javascript"></script>
</security:authorize>
