...
<html>
<head>
<title>EQUIPMENT LOG VIEWER | Airflow WCS</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0"/>
	<meta name="description" content="WRXJ - Equipment Log Viewer Screen"/>
	<meta charset="utf-8"/>
...
<div class="container-fluid">
	<div class="row">
		<spring:url value="/equiplogview/listSearch" var="formUrl"/>
										...
										<%------- Device -------%>
											<div class="form-group-sm col-sm-4">
												...
												<form:select path="deviceId" cssClass="form-control" id="scDeviceId">
													<form:options items="${dropdownMenus.commdevices}" />
												</form:select>
											</div>
										<div class="form-group-sm">
											<div class="col-sm-6">
...
<wrxj:ajaxTable metaDataName="WRxEquipLog" ajaxUri="/airflowwcs/equiplogview/empty" hasAutoRefresh="false" refreshRateSec="7"
	prefHideColumns="${userPrefs.tableColumnVisibility['WRxEquipLog']}"
	metaId="Timestamp" hasRefresh="true" hasFilter="true"
	theme="inverse" numPageLength="100"/>

<script src="<spring:url value="/resources/js/equiplogview.js"/>" type="text/javascript"></script>
