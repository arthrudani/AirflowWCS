...
<html>
<head>
	<title>LOAD TRANSACTION HISTORY | Airflow WCS</title>
...
<div class="container-fluid">
	<div class="row">
		<spring:url value="/loadtransactionhistory/listSearch" var="formUrl"/>
		<form:form cssClass="form-horizontal" id="history-filtering-form" action="${formUrl}" method="POST" modelAttribute="loadHistoryDataModel">
...
<wrxj:ajaxTable metaDataName="loadTransactionHistory" ajaxUri="/airflowwcs/loadtransactionhistory/list"
 	hasAutoRefresh="false" refreshRateSec="7" hasExcel="true"
 	metaId="loadTransactionHistory" hasRefresh="true" hasFilter="true"
 	theme="inverse" numPageLength="10"/>

<script src="<spring:url value="/resources/js/loadHistory.js"/>" type="text/javascript"></script>
