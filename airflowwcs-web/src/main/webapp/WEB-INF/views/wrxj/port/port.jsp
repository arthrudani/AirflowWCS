...
<wrxj:ajaxTable metaDataName="Port" ajaxUri="/airflowwcs/table/ajax?screen=port" 
				metaId="Name" hasRefresh="true" hasFilter="true" hasAdd="true"  ></wrxj:ajaxTable>
</security:authorize>
