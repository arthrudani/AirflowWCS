...
<html>
<head>
<title>LOG VIEWER | Airflow WCS</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0"/>
	<meta name="description" content="WRXJ - Log Viewer Screen"/>
	<meta charset="utf-8"/>
...
<div class="container-fluid">
	<div class="row">
		<spring:url value="/logview/listSearch" var="formUrl"/>
							...
							<div class="col-sm-6" >
								<div class="panel panel-default">
									<div class="panel-body">
										...
										<div class="form-group-sm">
											<div class="col-sm-6">
												<label for="scDescription">Filter</label>
												<form:input path="description" cssClass="form-control" id="scDescription" placeholder="Filter"/>
											</div>
										</div>
									</div>
								</div>
...
<wrxj:ajaxTable metaDataName="WRxLog" ajaxUri="/airflowwcs/logview/empty" hasAutoRefresh="false" refreshRateSec="7"
	prefHideColumns="${userPrefs.tableColumnVisibility['WRxLog']}"
	metaId="Timestamp" hasRefresh="true" hasFilter="true"
	theme="inverse" numPageLength="100"/>

<script src="<spring:url value="/resources/js/logview.js"/>" type="text/javascript"></script>
