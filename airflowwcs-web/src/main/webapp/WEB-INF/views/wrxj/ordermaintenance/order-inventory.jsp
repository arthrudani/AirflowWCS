...
<div class="container-fluid">
	<div class="row">
		<spring:url value="/load/listSearch" var="formUrl"/>
...
<wrxj:ajaxTable metaDataName="OrderHeader" ajaxUri="/airflowwcs/order/empty"
	prefHideColumns="${userPref.tableColumnVisibility['OrderHeader']}"
