...
<meta name="description" content="Airflow WCS - Zones">
<title>ZONES | Airflow WCS</title>
...
<wrxj:ajaxTable metaDataName="Zone" ajaxUri="/airflowwcs/zone/list"  prefHideColumns="${userPref.tableColumnVisibility['Zone']}"
				 metaId="Zone" hasRefresh="true" hasFilter="true" ></wrxj:ajaxTable>
