...
public class UserAuthGroupService
{
	/**
	* Log4j logger: UserManagementService
	*/
	private static final Logger logger = LoggerFactory.getLogger(UserAuthGroupService.class);
	...
	public List<UserAuthGroup> getUserAuthGroups(String userId)
	{
	    ...
	    try {
	    	  ...
	    	  if(!session.getTransaction().isActive())
	           ...
	           String hql = "from UserAuthGroup u where u.username = '" + userId + "'";
