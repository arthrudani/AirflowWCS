/*==========================================================================*/
/* Add WRxJ-Web table data to an ORACLE database 							*/
/*==========================================================================*/
/*
...
INSERT into asrs.WEBNAVOPTION (ID, AUTHGROUPNAME, NAVGROUPNAME, NAME, LINK, DESCRIPTION, ICON, FAVORITE, ORDERNO) VALUES (11, 'ROLE_USER', 'Inventory', 'Loads', '/load/view', 'Manage Loads', 'fa-inbox', 1, 1);
