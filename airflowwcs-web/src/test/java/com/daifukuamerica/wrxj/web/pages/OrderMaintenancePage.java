...
public class OrderMaintenancePage extends BrowserBasedObject implements Navigable
{
	public OrderMaintenancePage()
	{
		super(); 
	}
	
	static String title = "ORDER MAINTENANCE | WarehouseRx"; 

	@Override
	public void goTo()
	{
		Browser.goTo(NavigationConstants.VIEW_ORDER); 
	}
