...
/**
 * The context class for {@link ConveyorItemReleasedTransaction}. Should be instantiated by {@link ItemReleasedMessage}.
 * 
 * @author BT
 *
 */
public class ItemReleasedContext implements EBSTransactionContext {
    private final StationData stationData;
    private final LoadData loadData;
    private final LoadLineItemData loadLineItemData;
    ...
    /**
     * Constructor with values for {@link ConveyorItemReleasedTransaction}.
     * 
     * @param stationData
     * @param loadData
     ...
     * @param deviceId
     */
    public ItemReleasedContext(StationData stationData, LoadData loadData, LoadLineItemData loadLineItemData,
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ItemReleasedContext other = (ItemReleasedContext) obj;
    ...
    public String toString() {
        return "PLCReleasededContext [stationData=" + stationData + ", loadData=" + loadData + ", loadLineItemData="
