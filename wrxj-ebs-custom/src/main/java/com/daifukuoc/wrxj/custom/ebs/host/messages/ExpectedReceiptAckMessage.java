...
/**
 * Expected receipt ack message
 * 
 * @author LK
 *
 */
public class ExpectedReceiptAckMessage extends MessageOut {
     ...
     */
    public ExpectedReceiptAckMessage() {
        this(null);
    }
    
    public ExpectedReceiptAckMessage(MessageFormatter messageFormatter) {
        messageFields = new ColumnObject[] {
                new ColumnObject(MSGID_NAME, SACControlMessage.EXPECTED_RECIEPT_ACK_MSG_TYPE),
        ...
        enumMessageName = MessageOutNames.EXPECTED_RECEIPT_ACK;
    }
