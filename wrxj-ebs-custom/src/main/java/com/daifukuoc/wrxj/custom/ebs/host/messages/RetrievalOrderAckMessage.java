 ...
 *
 */
public class RetrievalOrderAckMessage extends MessageOut {
     ...
     */
    public RetrievalOrderAckMessage() {
        this(null);
    }
    
    public RetrievalOrderAckMessage(MessageFormatter messageFormatter) {
        messageFields = new ColumnObject[] {
                new ColumnObject(MSGID_NAME, SACControlMessage.RETRIEVAL_FLIGHT_REQUEST_ACK_MSG_TYPE),
        ...
        enumMessageName = MessageOutNames.RETRIEVAL_FLIGHT_REQUEST_ACK;
    }
