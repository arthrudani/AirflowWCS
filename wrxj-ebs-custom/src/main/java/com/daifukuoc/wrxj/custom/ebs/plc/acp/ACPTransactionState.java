...
public class ACPTransactionState {
    enum States {
    ...
    public ACPTransactionState(String portName, Logger logger) throws Exception {
        ...
        machine.addStateListener(new StateMachineListener<ACPTransactionState.States, ACPTransactionState.Events>() {
            @Override
