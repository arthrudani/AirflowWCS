...
public class FlightDataUpdateResponseMessage extends MessageOut {
     ...
     */
    public FlightDataUpdateResponseMessage() {
        this(null);
    }
    
    public FlightDataUpdateResponseMessage(MessageFormatter messageFormatter) {
        messageFields = new ColumnObject[] {
                new ColumnObject(MSGID_NAME, SACControlMessage.FLIGHT_DATA_UPDATE_ACK_MSG_TYPE),
        ...
        enumMessageName = MessageOutNames.FLIGHT_DATA_UPDATE;
    }
