...
/**
 * Inventory Request By Warehouse Ack Message
 * 
 * @author MT
 *
 */
public class InventoryReqByWarehouseAckMessage extends MessageOut {
     ...
     */
    public InventoryReqByWarehouseAckMessage() {
        this(null);
    }
    
    public InventoryReqByWarehouseAckMessage(MessageFormatter messageFormatter) {
        messageFields = new ColumnObject[] {
                new ColumnObject(MSGID_NAME, SACControlMessage.INVENTORY_REQUEST_BY_WAREHOUSE_ACK_MSG_TYPE),
        ...
        enumMessageName = MessageOutNames.INVENTORY_REQUEST_BY_WAREHOUSE_ACK;
    }
