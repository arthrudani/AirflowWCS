 ...
 *
 */
public class InventoryReqByFlightAckMessage extends MessageOut {
     ...
     */
    public InventoryReqByFlightAckMessage() {
        this(null);
    }
    
    public InventoryReqByFlightAckMessage(MessageFormatter messageFormatter) {
        messageFields = new ColumnObject[] {
                new ColumnObject(MSGID_NAME, SACControlMessage.INVENTORY_REQUEST_BY_FLIGHT_ACK_MSG_TYPE),
        ...
        enumMessageName = MessageOutNames.INVENTORY_REQUEST_BY_FLIGHT_ACK;
    }
