...
public class ConveyorAllocationController extends AllocationController {

	public ConveyorAllocationController()
	{
		super();
	}
            ...
            String requestingStation) throws DBException
	{
		...
		try
		{
			...
			{				
			  	//publishing Scheduler Notification to ConveyorScheduler
